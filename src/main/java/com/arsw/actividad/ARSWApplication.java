...
public class ARSWApplication {
    public static void main(String[] args) {
        ...
        System.out.println("ARSW-ACTIVIDAD iniciado en http://localhost:8081");
        System.out.println("Usando Redis Stream: banco.transferencias");
        System.out.println("Grupos: fraude, notificaciones, auditoria");
        System.out.println("Auditoría falla antes del ACK y se recupera mediante reproceso manual");
    }
}
